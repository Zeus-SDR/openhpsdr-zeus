...
When uncertain, implement the minimal fix and note in the PR description that design decisions need maintainer review. Douglas J. Cerrato (KB2UKA) and Christian Suarez (N9WAR) are the authorities on visual design, UX, and defaults.
